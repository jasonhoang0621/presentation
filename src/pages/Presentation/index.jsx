...
import { useDetailPresentation, useRemovePresentation } from 'src/api/presentation';
...
const Presentation = () => {
  ...
  const { mutateAsync: deletePresentation } = useRemovePresentation(presentationId);
  ...
  return (
    <div>
      ...
      >
        <div
          className={
            detailData.type === SlideType.HEADING || detailData.type === SlideType.PARAGRAPH
